<html>
  ...
  <body>
    ...
    <ul class="breadcrumb">
      ...
      <li><g:link action="show" id="\${${propertyName}?.id}"><g:message code="branding.nav.breadcrumb.${domainClass.propertyName.toLowerCase()}.show"/></g:link> <span class="divider">/</span></li>
      <li class="active"><g:message code="branding.nav.breadcrumb.${domainClass.propertyName.toLowerCase()}.edit"/></li>
    </ul>

    <g:render template="/templates/flash" plugin="aafApplicationBase"/>
    <g:render template="/templates/errors_bean" model="['bean':${propertyName}]" plugin="aafApplicationBase"/>

    <h2><g:message code="views.${domainClass.packageName.toLowerCase()}.${domainClass.name.toLowerCase()}.edit.heading" args="[]"/></h2>
    ...
    <g:form action="update" class="form-validating form-horizontal">
      ...
      <div class="form-actions">
        ...
        <g:link class="btn" action="show" id="\${${propertyName}?.id}"><g:message code="label.cancel"/></g:link>
      </div>
    </g:form>
