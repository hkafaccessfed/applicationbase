...
class ProcessSpec extends IntegrationSpec {
	...
	def "Ensure process with no finish task is invalid"() {
		...
		then:
		!result
		process.errors.getFieldError('tasks').code == 'workflow.process.validation.no.finish.task'
	}
	...
	def "Ensure process with tasks that depend on tasks not valid to the process are invalid"() {
		...
		then:
		!result
		process.errors.getFieldError('tasks').code == 'workflow.process.validation.tasks.dependencies.invalid.reference'
	}
	...
	def "Ensure process with rejections that depend on starting non-existing tasks are invalid"() {
		...
		then:
		!result
		process.errors.getFieldError('tasks').code == 'workflow.process.validation.tasks.rejections.invalid.start.reference'
	}
	...
	def "Ensure process with rejections that depend on terminating non existant tasks are invalid"() {
		...
		then:
		!result
		process.errors.getFieldError('tasks').code == 'workflow.process.validation.tasks.rejections.invalid.terminate.reference'
	}
	...
	def "Ensure process with outcomes that depend on starting non-existing tasks are invalid"() {
		...
		then:
		!result
		process.errors.getFieldError('tasks').code == 'workflow.process.validation.tasks.outcomes.invalid.start.reference'
	}
	...
	def "Ensure process with outcomes that depend on termininating non-existing tasks are invalid"() {
		...
		then:
		!result
		process.errors.getFieldError('tasks').code == 'workflow.process.validation.tasks.outcomes.invalid.terminate.reference'
	}
